...
Curve ftting with an asymmetric psuedo-Voigt function.
...
x = np.linspace(-6, 6)
pt = [250, -0.4, 2.0, 3.0, 0.4, 0.1]
yt = asym_psd_voigt(pt, x)
y = yt + np.sqrt(yt) * np.random.randn(x.size)

p0 = [100, -3.0, 3.0, 4.0, 0.2, 0.2]

## Ensure the widths are positive, and the mixing ratio is [0, 1].
bounds = [None, None, (0, None), (0, None), (0, 1), (-1, 1)]
